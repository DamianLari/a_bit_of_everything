...
import cv2
import glob
#le but -> refaire un système de motion capture. une fois que la calibration sera faite je pourrais me servir de plusieurs cameras et de mediapipe afin d'avoir une vue dans l'espace de mon corps et pouvoir l'utiliser sur unity ou autre
...
images1 = glob.glob('ImageFolder1/*.png')
images2 = glob.glob('ImageFolder1/*.png')
